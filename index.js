...
Window.prototype.create = function(url) {
  ...
  //setup for loading web-pages
  this.setup.allowRunningInsecureContent = true;
  this.setup.javascript = true;
  this.setup.webPreferences = {
    nodeIntegration: false,
    partition: "nightmare"
  };
  this.setup.maxAuthRetries = 3;
  this.setup.waitTimeout = 30000;
  this.setup.gotoTimeout = 30000;
  this.setup.pollInterval = 250;
  this.setup.typeInterval = 100;
  this.setup.executionTimeout = 30000;
  ...
  this.object.webContents.session.webRequest.onBeforeSendHeaders((details, callback) => {
    details.requestHeaders['User-Agent'] = "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.100 Safari/537.36";
    callback({
      cancel: false,
